...
- [ ] 🖼️ **[#13] Workspace Media Gallery Tab**: Research and design a dedicated workspace media tab (Tampilan / Kode / Media) allowing users to inspect uploaded project assets, usage status, and asset identifiers #workspace #media #future
