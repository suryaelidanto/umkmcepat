...
- [x] **Step 3: Create the pure module**
...
- [x] **Step 4: Remove moved declarations from the route + wire import**
...
- [x] **Step 7: Graphify no-duplicate check**
...
- [x] **Step 1: Capture the serving model eagerly for the error log**
...
- [x] **Step 2: Replace the bare catch in the one-call path**
...
- [x] **Step 3: Apply the same fix to the legacy path**
...
- [x] **Step 1: Write the repairToolCall callback**
...
- [x] **Step 2: Wire repairToolCall into the primary streamText**
...
- [x] **Step 3: Verify the fallback-through behavior**
...
- [x] **Step 1: Hoist a shared repair budget**
...
- [x] **Step 2: Guard the !chatText branch repair**
...
- [x] **Step 3: Guard the primaryToolFailed branch repair**
...
- [x] **Step 4: Typecheck + run discuss tests**
...
- [x] **Step 1: Add a degradation helper**
...
- [x] **Step 2: Route the !chatText all-repair-failed tail to degradation**
...
- [x] **Step 3: Route the primaryToolFailed all-repair-failed tail to degradation**
...
- [x] **Step 4: Route the hadError branch to degradation**
...
- [x] **Step 1: Create the env scratch file**
...
- [x] **Step 2: Write the sim harness**
...
- [x] **Step 4: Smoke-run the sim (2 runs, just to confirm it executes)**
...
- [x] **Step 5: Commit the harness (NOT the env or report)**
...
- [x] **Step 1: Run the full sim at 25 runs/fixture**
...
- [x] **Step 2: Read the report + check the gate**
...
- [x] **Step 4: Summarize for handoff**
