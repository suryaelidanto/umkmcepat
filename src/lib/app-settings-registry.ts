...
export const APP_SETTINGS: ConfigEntry[] = [
  ...
  },
  {
    ...
    tier: "advanced",
    type: "boolean",
    label: "Discuss hedging (parallel race)",
    fallback: false,
  ...
  },
  {
    ...
    tier: "advanced",
    type: "string",
    label: "AI — discuss hedge 2 model id",
    fallback: "",
    env: "AI_MODEL_DISCUSS_HEDGE_2",
    optionsSource: "nine_router_models",
  },
  {
    key: "ai.model.discuss_hedge_3",
    category: "ai",
    tier: "advanced",
    type: "string",
    label: "AI — discuss hedge 3 model id",
    fallback: "",
    env: "AI_MODEL_DISCUSS_HEDGE_3",
    optionsSource: "nine_router_models",
  },
  {
    key: "ai.model.build",
