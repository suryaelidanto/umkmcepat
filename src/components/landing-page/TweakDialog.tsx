...
// Mutation function
const sendTweakInstruction = async (data: TweakSchema): Promise<TweakApiResponse> => {
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          <DialogTitle className="flex items-center">
            <Bot className="mr-2 h-5 w-5"/> Tweak Konten dengan AI
          </DialogTitle>
          <DialogDescription>
            Berikan instruksi untuk mengubah konten halaman ini. Sisa jatah tweak: {tweaksLeft}x.
          </DialogDescription>
        </DialogHeader>
            ...
            <div>
                ...
                />
                 {form.formState.errors.instruction && (
                    <p className="mt-1 text-sm text-red-600">{form.formState.errors.instruction.message}</p>
                )}
            </div>
            <DialogFooter>
              <Button 
