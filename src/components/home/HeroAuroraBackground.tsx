...
export function HeroAuroraBackground() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-x-0 bottom-0 h-44 bg-gradient-to-t from-background via-aurora-orange/20 to-transparent dark:from-aurora-orange dark:via-aurora-rose/58" />
    </div>
  );
}
