...
import type { OwnEntry } from "@/lib/waitlist/waitlist-own-entry";
...
export type WaitlistFeatureProps = {
  initialOwn: OwnEntry | null;
  isAdmin: boolean;
};

export function WaitlistFeature({ initialOwn, isAdmin }: WaitlistFeatureProps) {
