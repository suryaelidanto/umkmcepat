...
export function WorkspaceCardView({
  ...
  if (card.type === "build_recommendation") {
    return (
      <div className="rounded-2xl border border-black/15 bg-[#faf9f5] p-4 shadow-xs transition-colors duration-200 dark:border-surface-warm-white/15 dark:bg-[#181816]">
        <div className="flex flex-col gap-3.5">
          ...
          <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
            <Button
              ...
              disabled={!canBuild}
              onClick={onBuild}
              className="h-9 flex-1 rounded-lg bg-[#1c1c1c] px-4 text-xs font-semibold text-white hover:bg-black disabled:opacity-50 dark:bg-surface-warm-white dark:text-foreground-primary dark:hover:bg-surface-warm-white/86 cursor-pointer"
            >
            ...
            {onDiscuss ? (
              <Button
                ...
                variant="outline"
                onClick={onDiscuss}
                className="h-9 rounded-lg border-black/15 bg-transparent px-4 text-xs font-medium text-[#5f5f5d] hover:bg-black/5 hover:text-[#1c1c1c] dark:border-surface-warm-white/12 dark:text-surface-warm-white/78 dark:hover:bg-surface-warm-white/8 cursor-pointer"
              >
                Lanjut diskusi dulu
              </Button>
            ) : null}
  ...
  if (card.type === "build_retry") {
    return (
      <div className="rounded-2xl border border-status-warning-border bg-[#faf9f5] px-spacing-5 py-spacing-5 shadow-xs transition-colors duration-200 dark:border-status-warning-border dark:bg-[#181816]">
        <div className="grid items-start gap-spacing-5 md:grid-cols-[minmax(0,1fr)_auto]">
          ...
          <div className="flex shrink-0 flex-wrap items-center gap-spacing-3 md:mt-spacing-6 md:flex-col md:items-stretch">
            <Button
              ...
              disabled={!canBuild}
              onClick={onBuild}
              className="rounded-lg bg-[#1c1c1c] px-spacing-5 text-white hover:bg-black disabled:opacity-50 dark:bg-surface-warm-white dark:text-foreground-primary dark:hover:bg-surface-warm-white/86 cursor-pointer"
            >
              Coba bangun lagi
            </Button>
            {onDiscuss ? (
              <Button
                ...
                variant="outline"
                onClick={onDiscuss}
                className="rounded-lg border-black/15 bg-transparent px-spacing-5 text-[#5f5f5d] hover:bg-black/5 hover:text-[#1c1c1c] dark:border-surface-warm-white/12 dark:text-surface-warm-white/78 dark:hover:bg-surface-warm-white/8 cursor-pointer"
              >
                Perbaiki brief dulu
              </Button>
            ) : null}
